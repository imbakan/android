...
public class Client implements Runnable {
    ...
    public static final int ATTRIBUTES   = 4001;
    ...
    public static final int CONNECTED   = 5002;
    private final int JOIN              = 5003;
    public static final int LEAVE       = 5004;
    private final int FORWARD           = 5005;
    private final int RESEND            = 5006;
    //private final int CLIENT_RUNNING = 5007; di na 'to kailangan dito, sa c++ lang
    ...
    public static final int REPLY_DEVICE = 7001;
    ...
    private final int ENUMERATE_DRIVE       = 8001;
    private final int ENUMERATE_DIRECTORY   = 8002;
    private final int ENUMERATE_FILE        = 8003;
    private final int ENUMERATE_CONTENT     = 8004;

    private final int DEPOPULATE_BY_DEVICE      = 9001;
    private final int POPULATE_WITH_DEVICE      = 9002;
    private final int POPULATE_WITH_DRIVE       = 9003;
    private final int POPULATE_WITH_DIRECTORY   = 9004;
    private final int POPULATE_WITH_FILE        = 9005;
    ...
    public Client(Handler handler, BluetoothSocket socket) {
    ...
    public void run() {
        ...
        sendMessage(LOG_MESSAGE, "Client thread has started.");
        ...
        sendMessage(LOG_MESSAGE, "Client thread has exited.");
